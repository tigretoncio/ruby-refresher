...
def select_elements_starting_with_vowel(array)
  array.select{ |word| word[0] =~ /[aAeEiIoOuU]/ }
end
...
def get_first_half_of_string(string)
  string.length.odd? ? string[0..string.length/2] : string[0..string.length/2-1]
end
...
def separate_array_into_even_and_odd_numbers(array)
  [array.select { |a| a.even? },array.select { |a| a.odd? }]
end
